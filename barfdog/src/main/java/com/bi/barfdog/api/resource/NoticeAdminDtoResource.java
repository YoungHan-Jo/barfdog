...
import com.bi.barfdog.api.NoticeAdminController;
...
public class NoticeAdminDtoResource extends EntityModel<QueryBlogsAdminDto> {
    public NoticeAdminDtoResource(QueryBlogsAdminDto dto, Link... links) {
        ...
        add(linkTo(NoticeAdminController.class).slash(dto.getId()).withRel("query_notice"));
        add(linkTo(NoticeAdminController.class).slash(dto.getId()).withRel("update_notice"));
        add(linkTo(NoticeAdminController.class).slash(dto.getId()).withRel("delete_notice"));
