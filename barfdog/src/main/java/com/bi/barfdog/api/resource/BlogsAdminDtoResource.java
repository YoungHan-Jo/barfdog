...
public class BlogsAdminDtoResource extends EntityModel<QueryBlogsAdminDto> {
    public BlogsAdminDtoResource(QueryBlogsAdminDto dto, Link... links) {
        ...
        add(linkTo(AdminApiController.class).slash("blogs").slash(dto.getId()).withRel("query_blog"));
        add(linkTo(AdminApiController.class).slash("blogs").slash(dto.getId()).withRel("update_blog"));
        add(linkTo(AdminApiController.class).slash("blogs").slash(dto.getId()).withRel("delete_blog"));
