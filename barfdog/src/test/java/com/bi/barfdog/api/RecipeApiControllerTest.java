        ...
        mockMvc.perform(get("/api/recipes")
                ...
                .andDo(document("query_recipes",
                        ...
                        responseFields(
                                ...
                                fieldWithPath("_embedded.recipeListResponseDtoList[0].pricePerGram").description("가격 상수"),
                                fieldWithPath("_embedded.recipeListResponseDtoList[0].gramPerKcal").description("무게 상수"),
                                fieldWithPath("_embedded.recipeListResponseDtoList[0].ingredients").description("재료 목록"),
        ...
        mockMvc.perform(RestDocumentationRequestBuilders.get("/api/recipes/{id}", recipe.getId())
                ...
                .andDo(document("query_recipe",
                        ...
                        responseFields(
                                ...
                                fieldWithPath("descriptionForSurvey").description("설문조사 시 노출시킬 특별히 챙겨주고 싶은 부분"),
                                fieldWithPath("filename1").description("썸네일1 파일 이름"),
                                fieldWithPath("thumbnailUri1").description("썸네일1 URI 주소"),
                                fieldWithPath("filename2").description("썸네일2 파일 이름"),
